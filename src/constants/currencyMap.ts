...
export const WethLogo = 'https://raw.githubusercontent.com/sushiswap/list/master/logos/token-logos/token/eth.jpg'
export const UsdcLogo = 'https://ethereum-optimism.github.io/data/USDC/logo.png'
